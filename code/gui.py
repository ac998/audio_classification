...
class Window(QWidget): #inherits from the QWidget class. QWidget widget is the base class of all user interface objects in PyQt5.
        ...
        def cleanse(self,wavFile):
            ...
            new_wavfile = []
            block_slice_length = 1 # frame length in seconds
            ...
            for i, start in enumerate(block_slices):
               ...
               #print("sample no = {}, start = {}, end = {}".format(i, start, end))
                ...
                max_threshold =0.65*block_max
                min_threshold = -0.65*block_max
        ...
        def predict(self):
            ...
            if self.featureName=='ACF':
                for res in self.y:
                    # if res == 1: print("machine+Nature")
                    # elif res == 0: print("music+Speech")
                    pass
                os.remove('predictionACF.csv')
            elif self.featureName == 'MFCC':
                for res in self.y:
                    if res == 0: print("machine")
                    elif res == 1: print("music")
                    elif res == 2: print("speech")
                    elif res == 3: print("nature")
        ...
        def continous_record(self):
            ...
            while(self.stopButtonBool == False):
                fs = 44100  # Sample rate
